...
n=8, del 3 [0, 1, 2, 8, 9]
```
We see the strange behaviour because everytime ```del number[i]``` is executed the i<sup>th</sup> element of list "numbers" is removed and the index no. of list is changing correspondingly.  
