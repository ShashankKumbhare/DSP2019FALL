...
3.	id(a) gives the id towards which the pointer 'a' is pointing. In this case, id(a) will give id of object '5'. aaaaaaaaaaaaaa aaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaa aaaaaaaaaaaaaa aaaaaaaaaaaaa aaa    
